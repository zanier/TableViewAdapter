...
typedef NS_OPTIONS(NSInteger, ZZTableRowItemPropertyType) {
    ZZRowProperty_cellHeight,
    ZZRowProperty_title,
    ZZRowProperty_detailText,
    ZZRowProperty_titleFont,
    ZZRowProperty_detailTextFont,
    ZZRowProperty_titleColor,
    ZZRowProperty_detailTextColor,
    ZZRowProperty_imageOrImageName,
    
    ZZRowProperty_selected,
    ZZRowProperty_highlighted,
    ZZRowProperty_showsReorderControl,
    ZZRowProperty_shouldIndentWhileEditing,
    ZZRowProperty_accessoryType,
    ZZRowProperty_accessoryView,
    ZZRowProperty_editingAccessoryType,
    ZZRowProperty_editingAccessoryView,
    ZZRowProperty_indentationLevel,
    ZZRowProperty_indentationWidth,
    ZZRowProperty_separatorInset,
    ZZRowProperty_editing,
    ZZRowProperty_focusStyle,
    ZZRowProperty_userInteractionEnabledWhileDragging,
    
    //ZZRowProperty_<#imageOrImageName#>,
};
