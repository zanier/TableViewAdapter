...
@property (nonatomic, assign, readonly) long long methodOptions;
...
@interface ZZTableViewRowDelegator : ZZTableViewDelegator
...
@interface ZZTableViewSectionDelegator : ZZTableViewDelegator
...
@interface ZZTableViewAdapterDelegator : ZZTableViewDelegator
